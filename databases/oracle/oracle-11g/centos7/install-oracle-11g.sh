...
export ORACLE_HOME_ROOT=/u01/app/oracle/product/11.2.0/
...
LIMITS_EOF
	...
	cat <<-NPROC_EOF > /etc/security/limits.d/90-nproc.conf
...
I18N_EOF
	...
	yum install -y binutils compat-libcap1 compat-libstdc++-33 compat-libstdc++-33.i686 gcc gcc-c++ glibc glibc.i686 glibc-devel glibc-devel.i686 ksh ksh.i686 libgcc libgcc.i686 libstdc++ libstdc++-devel libaio libaio-devel make sysstat libXext.686 libXext libXext-devel.686 libXext-devel
