...
function main {
	...
	case "${1}" in
		start)
			execute_as_user ${ORACLE_USER} start_oracle_database &> /home/${ORACLE_USER}/oracle-database.log &
			touch /var/lock/subsys/dbora
		;;
		stop)
			execute_as_user ${ORACLE_USER} stop_oracle_database &> /home/${ORACLE_USER}/oracle-database.log &
